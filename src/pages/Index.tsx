...
const Index = () => {
  return <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="section-fade-in">
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-foreground">Quem Somos</h2>
              <p className="text-lg text-muted-foreground mb-6">
                O Manda Tudo é uma distribuidora do ramo alimentício especializada em produtos de alta qualidade.
                Nascemos da paixão por distribuir sabores que trazem felicidade para milhares de famílias.
              </p>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-16">Nossos Valores</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8 rounded-xl bg-card shadow-card hover-lift">
              ...
              <p className="text-muted-foreground">
                Produtos selecionados com rigor para garantir a melhor experiência para nossos clientes.
              </p>
            </div>
            ...
            <div className="text-center p-8 rounded-xl bg-card shadow-card hover-lift">
              ...
              <p className="text-muted-foreground">
                Amor pelo que fazemos, levando sabores que alegram o dia a dia das pessoas.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-primary">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">Nossos Produtos</h2>
          <p className="text-white/90 max-w-3xl mx-auto mb-8 text-2xl">
            Trabalhamos com uma linha completa de produtos que atendem às necessidades de restaurantes, lanchonetes,
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-white">
              ...
              <p className="text-2xl mb-12 leading-relaxed font-normal md:text-2xl">Clique no botão abaixo para fazer parte da nossa comunidade de ofertas, o Manda Ofertas. Por lá você ficará sabendo de todas as nossas promoções todos os dias!</p>
      ...
      <section className="py-20 bg-secondary text-secondary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto text-secondary-foreground/80">
            Entre em contato conosco e descubra como podemos ajudar seu negócio a crescer com os melhores produtos do
            mercado.
          </p>
          <Button asChild variant="hero" size="lg">
            <Link to="/contato">
