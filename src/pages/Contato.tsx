        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-background rounded-2xl overflow-hidden shadow-card">
              ...
              <div className="h-80">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3667.8!2d-45.5544!3d-23.0267!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94cccf0e0e0e0e0f%3A0x0!2sRua%20Bom%20Jardim%2C%20139%20-%20Santa%20Luzia%2C%20Taubat%C3%A9%20-%20SP!5e0!3m2!1spt-BR!2sbr!4v1623456789012!5m2!1spt-BR!2sbr"
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }}
                  allowFullScreen 
                  ...
                  title="Mapa Loja 1 - Santa Luzia"
                />
              </div>
              <div className="p-6">
                <a 
                  href="https://www.google.com/maps/search/?api=1&query=Rua+Bom+Jardim+139+Santa+Luzia+Taubaté+SP"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center w-full px-6 py-3 rounded-lg bg-primary text-white font-semibold hover:opacity-90 transition-opacity"
                >
            ...
            <div className="bg-background rounded-2xl overflow-hidden shadow-card">
              ...
              <div className="h-80">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3667.5!2d-45.5556!3d-23.0262!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94cccf0e0e0e0e0f%3A0x0!2sRua%20Coronel%20Jo%C3%A3o%20Afonso%2C%2036%20-%20Centro%2C%20Taubat%C3%A9%20-%20SP!5e0!3m2!1spt-BR!2sbr!4v1623456789012!5m2!1spt-BR!2sbr"
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }}
                  allowFullScreen 
                  loading="lazy" 
                  referrerPolicy="no-referrer-when-downgrade"
                  title="Mapa Loja 2 - Centro"
                />
              </div>
              <div className="p-6">
                <a 
                  href="https://www.google.com/maps/search/?api=1&query=Rua+Coronel+João+Afonso+36+Centro+Taubaté+SP"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center w-full px-6 py-3 rounded-lg bg-primary text-white font-semibold hover:opacity-90 transition-opacity"
                >
